  ...
  describe "Validation" do
    ...
    context "when params is not a hash" do
      it "raise ZhimaAuthInvalidParams with message Params should be a hash" do
        ...
        expect{ZhimaAuth::CertifyRequest.new(params)}.to raise_error(ZhimaAuth::ZhimaAuthInvalidParams, "Params should be a hash")
      end
    end
    ...
    context "when params missing a key" do
      ...
      it "raise ZhimaAuthInvalidParams with message Params should include biz_no and return_url" do
        expect{ZhimaAuth::CertifyRequest.new(params)}.to raise_error(ZhimaAuth::ZhimaAuthInvalidParams, "Params should include biz_no and return_url")
      end
    end
    ...
    context "when params is with invalid return_url" do
      ...
      it "raise ZhimaAuthInvalidParams with message Invalid return url" do
        expect{ZhimaAuth::CertifyRequest.new(params)}.to raise_error(ZhimaAuth::ZhimaAuthInvalidParams, "Invalid return url")
      end
    end
    ...
    context "when params biz_no is with invalid length" do
      ...
      it "raise ZhimaAuthInvalidParams with message Invalid biz no" do
        expect{ZhimaAuth::CertifyRequest.new(params)}.to raise_error(ZhimaAuth::ZhimaAuthInvalidParams, "Invalid biz no")
      end
    end
  end
end
